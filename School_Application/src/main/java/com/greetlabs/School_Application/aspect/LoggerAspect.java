package com.greetlabs.School_Application.aspect;
...
public class LoggerAspect {
    @Around("executiomn(* com.greetlabs.School_Application..*.*(..))")
    public Object log(ProceedingJoinPoint joinPoint) throws Throwable{
        ...
        log.info(joinPoint.getSignature().toString() + " method is end");
        return returnObj;
    }
